#
#  Be sure to run `pod spec lint JDragonSoap.podspec' to ensure this is a
...
#  s.license      = { :type => "MIT", :file => "LICENSE" }
  ...
  s.source       = {:git => "https://github.com/lyc59621/JDragonSoap.git", :tag => "0.0.7" }
...
#
  ...
  #
  s.source_files  = "JDragonSoap/*.{h,m}"
